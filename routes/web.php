...
Route::group(['middleware' => ['auth', 'active']], function() {
    ...
    Route::get('/sales/create/gen', 'SaleController@instantProductgencode')->name('genInstantCode');
    Route::post('/instant/product/add/purchase', 'SaleController@instantProductAddPurchase')->name('instant.product.add.purchase');
	...
	Route::get('report/sale_report', 'ReportController@saleReport')->name('report.sale');
    ...
    Route::post('/task-note/read/{id}', 'HomeController@markNoteRead')->name('task.note.read');
    Route::post('/task-attach/read/{id}', 'HomeController@markAttachRead')->name('task.attach.read');
