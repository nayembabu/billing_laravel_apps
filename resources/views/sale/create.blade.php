@extends('layout.main') @section('content')
    ...
    <section class="forms">
        <div class="container-fluid">
            <div class="row">
                    ...
                    <div class="card">
                        <div class="card-header d-flex align-items-center justify-content-between">
                            ...
                            <button type="button" class="btn btn-primary btn-sm" data-toggle="modal"
                                data-target="#instantProduct">Add Product</button>
                        </div>
                        <div class="card-body">
                            <p class="italic">
                            ...
                            <input type="hidden" name="sale_type" value="add_sale">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select required name="customer_id" id="customer_id"
                                                    value="{{ old('customer_id') }}" class="selectpicker form-control"
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select required name="warehouse_id" id="warehouse_id"
                                                    value="{{ old('warehouse_id') }}" class="selectpicker form-control"
                                                ...
                                                <table id="myTable" class="table table-hover order-list">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th>{{ trans('file.Net Weight') }}</th>
                                                            <th>{{ trans('file.Gross Weight') }}</th>
                                                    ...
                                                    <tfoot class="tfoot active">
                                                        ...
                                                        <th></th>
                                                        <th></th>
                                                        <th id="total-discount"  style="display: none;">0.00</th>
                                                        <th id="total-discount2">0.00</th>
                                                        <th id="total-tax" style="display: none;">0.00</th>
                                                        <th id="total-tax2" >0.00</th>
                                                        <th id="total" style="display: none;">0.00</th>
                                                        <th id="total2" >0.00</th>
                                                        <th><i class="dripicons-trash"></i></th>
                                                    </tfoot>
                                                </table>
                                            </div>
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>
                                                    {{ trans('file.Pickup Cost') }}
                                                </label>
                                                <input type="number" name="pickup_cost" class="form-control"
                                                    step="any" />
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>
                                                    {{ trans('file.Packaging Cost') }}
                                                </label>
                                                <input type="number" name="packaging_cost" class="form-control"
                                                    step="any" />
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>
                                                    {{ trans('file.BD Charges') }}
                                                </label>
                                                <input type="number" name="bd_charges_cost" class="form-control"
                                                    step="any" />
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-4">
                                            <span style="display:none;" id="labelCurrency"></span>
                                            <div class="form-group" id="currencyChangeDiv">
                                                <label>{{ trans('file.Currency') }}</label>
                                                <select required name="currency_id" id="currencyID"
                                                    class="selectpicker form-control" data-live-search="true"
                                                    data-live-search-style="begins" title="Select Currency...">
                                                    @foreach ($lims_currency_all as $cur)
                                                        <option
                                                            {{ $lims_default_currency->currency == $cur->id ? 'selected' : '' }}
                ...
                <!-- Modal for add & purchase instant product -->
                <div class="modal fade" id="instantProduct" tabindex="-1" role="dialog"
                    aria-labelledby="instantProductLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title" id="instantProductLabel">Add Instant Product</h4>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            <div class="modal-body">
                                <form action="{{ route('instant.product.add.purchase') }}" id="product-form" method="POST">
                                    @csrf
                                    <!-- add product -->
                                    <h6>Add Product</h6>
                                    <hr>
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" name="unique_code" class="form-control"
                                                        id="unique_code" aria-describedby="unique_code" required>
                                        ...
                                        <div id="unit" class="col-md-4 form-group">
                                        ...
                                        <div id="alert-qty" class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="alert_quantity" class="form-control" step="any" value="1">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="order_discount" class="form-control" step="any" value="0" />
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>
                                                    <strong>{{trans('file.Quantity')}}</strong>
                                                </label>
                                                <input type="number" name="qty" class="form-control" step="any" value="1" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group d-grid d-md-flex justify-content-md-end">
        ...
        <div class="container-fluid">
            <table class="table table-bordered table-condensed totals">
                ...
                <td><strong>{{ trans('file.grand total') }}</strong>
                    ...
                    <span class="pull-right" id="grand_total2" style="display: none;">0.00</span>
                </td>
            </table>
        </div>
                        ...
                        <form>
                            <div class="row modal-element">
                                <div class="col-md-4 form-group">
                                    ...
                                    <input type="text" name="edit_product_name" class="form-control numkey">
                                </div>
                                ...
                                <input type="hidden" name="edit_product_code" class="form-control numkey"
                                step="any" />
                                ...
                                <div id="edit_gross_weight" class="col-md-4 form-group">
                                    ...
                                    <input type="number" name="edit_gross_weight" class="form-control" />
                                </div>
                            </div>
    ...
    <input type="hidden" id="currencyExchangeRate" value="{{ $getCurrencyExchangeRate }}">
@endsection
...
@push('scripts')
        ...
        $(document).on('change', '#currencyID', function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('#labelCurrency').css('display', 'block');
                    $('#labelCurrency').html('<span>Selling Currency: <strong>' + response
                        .currency_name + '</strong></span>')
                    $('#currencyChangeDiv').css('display', 'none');

                    // update net unit price on currency onchange
                    $('.net_unit_price').each(function() {
                        var unit_price = parseFloat($(this).text());
                        $(this).text((unit_price * response.rate).toFixed(2));
                    });
                    // update sub total price on currency onchange
                    $('.sub-total').each(function() {
                        var sub_total = parseFloat($(this).text());
                        $(this).text((sub_total * response.rate).toFixed(2));
                    });
                    // update tax price on currency onchange
                    $('.tax').each(function() {
                        var tax = parseFloat($(this).text());
                        $(this).text((tax * response.rate).toFixed(2));
                    });
                    // update discount price on currency onchange
                    $('.discount').each(function() {
                        var discount = parseFloat($(this).text());
                        $(this).text((discount * response.rate).toFixed(2));
                    });
                    ...
                    $("#total-discount2").text(total_discount.toFixed(2));
                    ...
                    $("#total-tax2").text(total_tax.toFixed(2));
                    ...
                    $("#shipping_cost").text($('input[name="shipping_cost"]').val() * response.rate);
                    $("#order_tax").text($('input[name="order_tax"]').val() * response.rate);
                    $("#grand_total").text($('input[name="grand_total"]').val() * response.rate);
                    $('#order_discount').text($('input[name="order_discount"]').val() * response.rate);
    ...
    <script>
        ...
        $('#genbutton').on("click", function() {
            $.get("{!! route('genInstantCode') !!}", function(data) {
                $("input[name='unique_code']").val(data);
            });
        });
    </script>

    <script type="text/javascript">
        var currencyExchangeRate = $('#currencyExchangeRate').val();
        ...
        $('button[name="update_btn"]').on("click", function() {
            ...
            var edit_product_name = $('input[name="edit_product_name"]').val();
            var edit_product_code = $('input[name="edit_product_code"]').val();
            var edit_unit_price = $('input[name="edit_unit_price"]').val();
            var edit_net_weight = $('input[name="edit_net_weight"]').val();
            var edit_gross_weight = $('input[name="edit_gross_weight"]').val();
            $('.net_weight'+edit_product_code).val(edit_net_weight);
            $('.gross_weight'+edit_product_code).val(edit_gross_weight);

            $('.net_weight_td'+edit_product_code).text(edit_net_weight);
            $('.gross_weight_td'+edit_product_code).text(edit_gross_weight);
            ...
            $('#temp_prod_name_' + edit_product_code).text(edit_product_name);
            $('.temp_product_name_' + edit_product_code).val(edit_product_name);
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (flag) {
                        ...
                        cols += '<td><span id="temp_prod_name_'+ data[1] +'">' + data[0] +
                            '</span><button type="button" class="edit-product btn btn-link" data-toggle="modal" data-target="#editModal"> <i class="dripicons-document-edit"></i></button></td>';
                        cols += '<td>' + data[1] + '</td>';
                        ...
                        if(data[16] == null){
                            ...
                            cols += '<td class="net_weight_td'+data[1]+'">0</td>';
                        }else{
                            cols += '<td class="net_weight_td'+data[1]+'">'+data[16]+'</td>';
                        }
                        if(data[17] == null){
                            cols += '<td class="gross_weight_td'+data[1]+'">0</td>';
                        }else{
                            cols += '<td class="gross_weight_td'+data[1]+'">'+data[17]+'</td>';
                        }
                        ...
                        cols += '<input type="hidden" class="sale-unit" name="sale_unit[]" value="' +
                            temp_unit_name[0] + '"/>';
                        cols += '<input type="hidden" class="temp_product_name_'+ data[1] +'" name="temp_product_name[]" />';
                        ...
                        if(data[16] == null){
                            cols += '<input type="hidden" class="net_weight'+data[1]+'" name="net_weight[]" value="" />';
                        }else{
                            cols += '<input type="hidden" class="net_weight'+data[1]+'" name="net_weight[]" value="'+data[16]+'" />';
                        }
                        if(data[17] == null){
                            cols += '<input type="hidden" class="gross_weight'+data[1]+'" name="gross_weight[]" value="" />';
                        }else{
                            cols += '<input type="hidden" class="gross_weight'+data[1]+'" name="gross_weight[]" value="'+data[17]+'" />';
                        }
        ...
        function edit() {
            ...
            $('input[name="edit_product_code"]').val(row_product_code);
            ...
            // $('.net_weight_td'+row_product_code).text($('input[name="edit_net_weight"]').val());
            // $('.gross_weight_td'+row_product_code).text($('input[name="edit_gross_weight"]').val());
        ...
        function calculateGrandTotal() {
            ...
            var pickup_cost = parseFloat($('input[name="pickup_cost"]').val());
            var delivery_cost = parseFloat($('input[name="delivery_cost"]').val());
            var packaging_cost = parseFloat($('input[name="packaging_cost"]').val());
            var bd_charges_cost = parseFloat($('input[name="bd_charges_cost"]').val());
            ...
            if (!packaging_cost)
                packaging_cost = 0.00;
            if (!bd_charges_cost)
                bd_charges_cost = 0.00;

            item = ++item + '(' + total_qty + ')';
            order_tax = (subtotal - order_discount) * (order_tax / 100);
            var grand_total = (subtotal + order_tax + shipping_cost + pickup_cost + delivery_cost + packaging_cost + bd_charges_cost) - order_discount;
            ...
            $('#grand_total2').text(grand_total.toFixed(2));
        ...
        $('input[name="pickup_cost"]').on("input", function() {
            calculateGrandTotal();
        });
        $('input[name="delivery_cost"]').on("input", function() {
            calculateGrandTotal();
        });
        $('input[name="packaging_cost"]').on("input", function() {
            calculateGrandTotal();
        });
        $('input[name="bd_charges_cost"]').on("input", function() {
            calculateGrandTotal();
        });
