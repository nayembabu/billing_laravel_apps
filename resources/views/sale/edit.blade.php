                                                        ...
                                                        @foreach ($lims_product_sale_data as $product_sale)
                                                            <tr>
                                                                ...
                                                                @else
                                                                    ...
                                                                    <td>N/A</td>
                                                                @endif
                                                                @if($product_sale->net_weight)
                                                                    <td class="net_weight_td{{$product_data->code}}">{{ $product_sale->net_weight }}</td>
                                                                    @else 
                                                                    <td class="net_weight_td{{$product_data->code}}">0</td>
                                                                @endif
                                                                @if($product_sale->gross_weight)
                                                                    <td class="gross_weight_td{{$product_data->code}}">{{ $product_sale->gross_weight }}</td>
                                                                    @else 
                                                                    <td class="gross_weight_td{{$product_data->code}}">0</td>
                                                                @endif
                                                                ...
                                                                <input type="hidden" class="imei-number"
                                                                    ...
                                                                    @if($product_sale->net_weight == null)
                                                                        <input type="hidden" class="net_weight{{ $product_data->code }}" name="net_weight[]" value="" />
                                                                    @else
                                                                        <input type="hidden" class="net_weight{{ $product_data->code }}" name="net_weight[]" value="{{ $product_sale->net_weight }}" />
                                                                    @endif
                                                                    @if($product_sale->gross_weight == null)
                                                                        <input type="hidden" class="gross_weight{{ $product_data->code }}" name="gross_weight[]" value="" />
                                                                    @else
                                                                    <input type="hidden" class="gross_weight{{ $product_data->code }}" name="gross_weight[]" value="{{ $product_sale->gross_weight }}" />
                                                                    @endif
                                                            </tr>
                                                        @endforeach
                                                    </tbody>
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" value="{{ $lims_sale_data->pickup_cost }}" name="pickup_cost" class="form-control"
                                                    step="any" />
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" value="{{ $lims_sale_data->delivery_cost }}" name="delivery_cost" class="form-control"
                                                    step="any" />
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" value="{{ $lims_sale_data->packaging_cost }}" name="packaging_cost" class="form-control"
                                                    step="any" />
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" value="{{ $lims_sale_data->bd_charges_cost }}" name="bd_charges_cost" class="form-control"
                                                    step="any" />
                                            </div>
                                        </div>
                                        <div class="col-md-4">
