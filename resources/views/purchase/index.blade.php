...
@push('scripts')
    <script type="text/javascript">
        ...
        $("#print-btn").on("click", function() {
            ...
            a.document.write(
                '<body><style>body{font-family: sans-serif;line-height: 1.15;-webkit-text-size-adjust: 100%;}.d-print-none{display:none}.text-center{text-align:center}.row{width:100%;margin-right: -15px;margin-left: -15px;}.col-md-12{width:100%;display:block;padding: 5px 15px;}.col-md-6{width: 50%;float:left;padding: 5px 15px;}table{width:100%;margin-top:30px;}th{text-aligh:left;}td{padding:10px}table, th, td{border: 1px solid black; border-collapse: collapse;}table th,table td{padding: 2px;padding-left:3px}</style><style>@media print {.modal-dialog { max-width: 1000px;} }</style>'
                );
        ...
        function purchaseDetails(purchase) {
            var htmltext =
                '<table border="0" cellspacing="0" width="100%"><tr border="0" style=text-align:left><th></th><th></th></tr><tr style=text-align:left><td><b>{{ trans('file.Date') }}:</b> ' +
                purchase[0] + ' <br><b>{{ trans('file.reference') }}:</b> ' + purchase[1] +
                ' <br><b>{{ trans('file.Purchase Status') }}:</b>' + purchase[2] +
                '</br></td><td><h3>{{ $general_setting->site_title }}</h3></td></tr></table><table border="0" cellspacing="0" width="100%"><tr style=text-align:left><th>From</th><th>To</th></tr><tr style=text-align:left><td>' +
                purchase[4] + '<br>' + purchase[5] + '<br>' + purchase[6] + '<br>' + purchase[7] +
                '<br></td><td>' + purchase[7] + '<br>' + purchase[8] + '<br>' + purchase[9] + '<br>' + purchase[10] +
                '<br>' + purchase[11] + '<br>' + purchase[12] +
                '<br></td></tr></table>';
            ...
            $.get('purchases/product_purchase/' + purchase[3], function(data) {
                ...
                var newRow = $("<tr>");
                cols = '';
                cols += '<td style=text-align:right colspan=5><strong>{{ trans('file.Total') }}:</strong></td>';
                ...
                cols = '';
                cols +=
                '<td style=text-align:right colspan=7><strong>{{ trans('file.Order Tax') }}:</strong></td>';
                ...
                cols = '';
                cols +=
                    '<td style=text-align:right colspan=7><strong>{{ trans('file.Order Discount') }}:</strong></td>';
                ...
                cols = '';
                cols +=
                    '<td style=text-align:right colspan=7><strong>{{ trans('file.Shipping Cost') }}:</strong></td>';
                ...
                cols = '';
                cols +=
                    '<td style=text-align:right colspan=7><strong>{{ trans('file.grand total') }}:</strong></td>';
                ...
                cols = '';
                cols +=
                    '<td style=text-align:right colspan=7><strong>{{ trans('file.Paid Amount') }}:</strong></td>';
                ...
                var newRow = $("<tr>");
                cols = '';
                cols += '<td style=text-align:right colspan=7><strong>{{ trans('file.Due') }}:</strong></td>';
            ...
            var htmlfooter = '<p><strong>{{ trans('file.Note') }}:</strong> ' + purchase[22] +
                '<table cellspacing="0" width="100%"><tr><th>Created By</th><th>Trailer</th></tr><tr><td><b>Signature: </b><br><b>Name: </b> ' +
                purchase[23] + ' <br><b>Email: </b> ' + purchase[24] +
                '</td><td><b>Signature: </b><br><b>ID: </b></td></tr></table><br><p style="font-size:12px;border:1px solid black;padding:2px 4px;bottom:0;width:auto;">Bank Details: Banglacarparts; Sort code:******; AC No: *****; Bank name: The Co-Operative Ban</p>';
