              ...
              <div class="row">
                ...
                <div class="col-sm-3">
                  <div class="wrapper count-title">
                    ...
                    <div>
                        ...
                        <div class="name"><strong style="color: #733686">{{ trans('file.total sale') }}{{ trans('file.pound-symbol') }}</strong></div>
                    </div>
                  </div>
                </div>
                <!-- Count item widget-->
                <div class="col-sm-3">
                  <div class="wrapper count-title">
                    ...
                    <div>
                        <div class="count-number total-purchase">{{number_format((float)$purchase, 2, '.', '')}}</div>
                        <div class="name"><strong style="color: #ff8952">{{trans('file.total purchase')}}{{ trans('file.pound-symbol') }}</strong></div>
                    </div>
                  </div>
                </div>
                <!-- Count item widget-->
                <div class="col-sm-3">
                  <div class="wrapper count-title">
                    ...
                    <div>
                        <div class="count-number total-expense-data">{{number_format((float)$expense, 2, '.', '')}}</div>
                        <div class="name"><strong style="color: #00c689">{{trans('file.total expense')}}{{ trans('file.pound-symbol') }}</strong></div>
                    </div>
                  </div>
                </div>
                <!-- Count item widget-->
                <div class="col-sm-3">
                  <div class="wrapper count-title">
                    ...
                    <div>
                        ...
                        <div class="name"><strong style="color: #297ff9">{{trans('file.profit')}}{{ trans('file.pound-symbol') }}</strong></div>
                    </div>
                  </div>
                </div>
                <!-- Count item widget-->
                <div class="col-sm-3">
                  <div class="wrapper count-title">
                    <div class="icon"><i class="dripicons-wallet" style="color: #3349FF"></i></div>
                    <div>
                        <div class="count-number cash-in-hand">{{number_format((float)($payment_recieved_index - $payment_sent_index - $return_index[0]->grand_total + $purchase_return_index[0]->grand_total - $expense_index - $payroll_index), 2, '.', '') }}</div>
                        <div class="name"><strong style="color: #3349FF">{{trans('file.Cash in Hand')}}{{ trans('file.pound-symbol') }}</strong></div>
                    </div>
                  </div>
                </div>
...
<script type="text/javascript">
    ...
    function dashboardFilter(data){
        ...
        $('.total-purchase').hide();
        $('.total-purchase').html(parseFloat(data[4]).toFixed(2));
        $('.total-purchase').show(500);

        $('.total-expense-data').hide();
        $('.total-expense-data').html(parseFloat(data[5]).toFixed(2));
        $('.total-expense-data').show(500);

        $('.cash-in-hand').hide();
        $('.cash-in-hand').html(parseFloat(data[6]).toFixed(2));
        $('.cash-in-hand').show(500);
