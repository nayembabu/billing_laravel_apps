                    ...
                    <div class="card-body">
                        ...
                        <form id="product-form">
                            ...
                            <div class="row">
                                ...
                                <div id="net_weight" class="col-md-4">
                                    <div class="form-group">
                                        <label>{{trans('file.Net Weight')}}</strong> </label>
                                        <input type="number" placeholder="Net Weight" name="net_weight" value="{{ $lims_product_data->net_weight }}" class="form-control" step="any">
                                    </div>
                                </div>
                                <div id="gross_weight" class="col-md-4">
                                    <div class="form-group">
                                        <label>{{trans('file.Gross Weight')}}</strong> </label>
                                        <input type="number"  value="{{ $lims_product_data->gross_weight }}"  placeholder="Gross Weight" name="gross_weight" class="form-control" step="any">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
