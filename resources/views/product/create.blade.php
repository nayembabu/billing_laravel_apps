                            ...
                            <div class="row">
                                ...
                                <div id="net_weight" class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" placeholder="Net Weight" name="net_weight" class="form-control" step="any">
                                    </div>
                                </div>
                                <div id="gross_weight" class="col-md-4">
                                    <div class="form-group">
                                        <label>{{trans('file.Gross Weight')}}</strong> </label>
                                        <input type="number" placeholder="Gross Weight" name="gross_weight" class="form-control" step="any">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
