          ...
          <div class="form-inner">
            ...
            <form method="POST" action="{{ route('login') }}" id="login-form">
              ...
              <div class="form-group-material">
                <input id="login-username" type="text" name="name" required class="input-material" value="" autocomplete="off">
              ...
              <div class="form-group-material">
                <input id="login-password" type="password" name="password" required class="input-material" value="" autocomplete="off">
...
<script type="text/javascript">
  ...
  $('.customer-btn').on('click', function(){
      $("input[name='name']").focus().val('customer');
